...
/**
 * Write a description of class SatisticViewer here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class SatisticViewer extends Application
{
    // instance variables - replace the example below with your own
    private SatisticEngine stat;// = new SatisticEngine();
    ...
    public SatisticViewer(){
        stat = new SatisticEngine();
        fillStatisticMap();
        fillShownMap();
    }
    ...
    public void start(Stage stage) throws Exception{
        URL url = getClass().getResource("satisticPane.fxml");
        Pane root = FXMLLoader.load(url);
        //fillLabels();
        Scene scene = new Scene (root);

        stage.setTitle("Airbnb Statistics");
